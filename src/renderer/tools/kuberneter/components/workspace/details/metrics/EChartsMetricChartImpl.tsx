...
import type { EChartsMetricChartProps } from './EChartsMetricChart';

export const EChartsMetricChartImpl: React.FC<EChartsMetricChartProps> = ({
  title,
  timeLabels,
  series,
  unit = '',
...
export default EChartsMetricChartImpl;
