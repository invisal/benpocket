export const IpcChannels = {
  ...
  CaptureScreenshotPortalTick: 'screenshot:capture-portal-tick',
  CaptureScreenshotPortalCancel: 'screenshot:capture-portal-cancel',
  ...
  KeybindingFire: 'keybindings:fire',
