...
import { HELM_INSTALL_GUIDES, getDetectedOS, OS_NAMES, type PlatformOS } from './helmInstallGuides';

export function HelmInstallGuide() {
  ...
  const guide = HELM_INSTALL_GUIDES[activeGuideOs];
